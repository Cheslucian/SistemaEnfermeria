            ...
            <div class="card-body">
                <ul>
                    ...
                    @if($role == 'paciente' || $role == 'admin')
                        <dd>
                            <strong>Enfermera:</strong> {{$appointment->enfermera->usuario}}
                        </dd>
                    @endif
                    @if($role == 'enfermera' || $role == 'admin')
                        <dd>
                            <strong>Paciente:</strong> {{$appointment->patient->usuario}}
                        </dd>
                    @endif
                    <dd>
                    ...
                    <dd>
                        ...
                        @else
                            ...
                            <span class="badge badge-primary"> 'estrellitas'</span>
