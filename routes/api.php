...
Route::get('/especialidades/{specialty}/enfermeros', [App\Http\Controllers\Api\SpecialtyController::class, 'enfermeras']);
...
Route::middleware('auth:api')->group(function(){
    ...
    Route::post('/appointments/{id}/rate', [App\Http\Controllers\Api\AppointmentController::class, 'rate']);
