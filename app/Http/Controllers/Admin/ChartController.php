...
class ChartController extends Controller
{
    ...
    public function enfermeras(){
        ...
        return view('charts.enfermeras', compact('end', 'start'));
    }
    ...
    public function enfermerasJson(Request $request){
        ...
        $data = [];
        $data['categories'] = $enfermeras->pluck('usuario');

        $series = [];
        $series1['usuarios'] = 'Citas atendidas';
        $series1['data'] = $enfermeras->pluck('attended_appointments_count');
        $series2['usuarios'] = 'Citas canceladas';
        $series2['data'] = $enfermeras->pluck('cancell_appointments_count');
